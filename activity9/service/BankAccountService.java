package m4.activity9.service;

import m4.activity9.exception.AccountNotFoundException;
import m4.activity9.exception.InsufficientFundsException;
import m4.activity9.exception.InvalidAccountException;
import m4.activity9.exception.InvalidTransferException;
import m4.activity9.model.BankAccount;
...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			throw new InvalidAccountException(String.format("Initial balance cannot be less than %.2f. Received Amount: %.2f", MINIMUM_INITIAL_BALANCE, initialBalance));
		}
		...
		if (accountExists(accountNumber)) {
			...
			throw new InvalidAccountException("Account already exists: " + accountNumber);
	...
	public void transfer(String fromAccountNumber, String toAccountNumber, double amount)
		...
		if (fromAccount.getBalance() < amount) {
			...
			throw new InsufficientFundsException(String.format("Insufficient funds; Balance: %.2f Required: %.2f", fromAccount.getBalance(), amount));
